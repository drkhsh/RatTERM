...
impl MainWindow {
    fn terminal_info_snapshot(&self) -> terminal_info_dialog::TerminalInfo {
        ...
        terminal_info_dialog::TerminalInfo {
            ...
            kitty_stack_depth: state.kitty_keyboard.depth(),
            ...
            origin_within_margins: state.origin_mode == icy_engine::OriginMode::WithinMargins,
            dec_left_right_margins: state.dec_left_right_margins(),
            ...
            Message::McpCommand(cmd) => {
                match cmd.as_ref() {
                    ...
                    McpCommand::CaptureScreen(format, response_tx) => {
                        ...
                        let data = {
                            let mut screen = self.terminal_window.terminal.screen.lock();
                            let opt = icy_engine::SaveOptions::ansi(icy_engine::AnsiCompatibilityLevel::Utf8Terminal);
                            match format {
