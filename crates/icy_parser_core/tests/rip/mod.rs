...
#[test]
fn test_rip_2_scene_control_commands() {
    let mut parser = RipParser::new();
    let mut sink = TestSink::new();

    parser.parse(b"!|h010A0100|!generated by RIPaint|(|)|c0F\n", &mut sink);
    ...
    assert_eq!(
        ...
        [
            ...
            RipCommand::Comment {
                text: "generated by RIPaint".to_string(),
            },
            RipCommand::GroupBegin,
            RipCommand::GroupEnd,
...
#[test]
fn test_rip_unsupported_later_level_command_preserves_following_command() {
    let mut parser = RipParser::new();
    let mut sink = TestSink::new();

    parser.parse(b"!|21Tabcd|c0F\n", &mut sink);
